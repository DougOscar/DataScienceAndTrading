...
High precision = fewer but more reliable signals. For trading, precision > 0.55 is a reasonable starting target — measure the actual achievable level on your own instrument and costs rather than assuming a fixed number.
