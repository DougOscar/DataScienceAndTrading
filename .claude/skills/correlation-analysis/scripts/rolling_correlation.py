...
Computes rolling correlation between two instruments at multiple windows,
detects correlation regime changes using z-score methodology, and estimates
tail dependence to assess crash/risk-off co-movement.
...
To use with real data, load your own two return series (e.g. from an MT5
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Days of history to generate (default: 365)"
    )
    ...
    print("  Swap generate_demo_data() for your own two MT5/quantlab return")
    print("  series to run this on real instruments.")
    returns_a, returns_b, name_a, name_b = generate_demo_data(n_days=args.days)
