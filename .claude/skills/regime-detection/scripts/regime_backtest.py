...
def compute_adx(
    ...
    """Average Directional Index (Wilder smoothing, alpha=1/period)."""
    ...
    plus_di = 100 * plus_dm_copy.ewm(alpha=alpha, adjust=False).mean() / atr
    minus_di = 100 * minus_dm_copy.ewm(alpha=alpha, adjust=False).mean() / atr
