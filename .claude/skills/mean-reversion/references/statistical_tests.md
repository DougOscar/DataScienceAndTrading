...
| Hurst Range | Behavior | Strength | Typical Context |
|-------------|----------|----------|---------------|
| 0.0 - 0.3   | Strongly mean-reverting | High | Rare on outright price; cointegrated spreads |
| 0.3 - 0.45  | Mean-reverting | Moderate | FX/metals cross spreads, B3 intraday ranges |
| 0.45 - 0.55 | Random walk | None | Many outright FX/metals prices on swing timeframes |
| 0.55 - 0.70 | Trending | Moderate | Outright price during a directional regime |
| 0.70 - 1.0  | Strongly trending | High | Strong trend/breakout regimes; measure on your own data — don't assume a fixed range |
