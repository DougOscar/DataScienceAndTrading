...
for far in (False, True):
    ...
    if far:
        ...
        r1.select(cols).write_csv(__import__("os").path.join(__import__("os").path.dirname(__file__), "p07_trades_m1.csv"))
        r0.select(cols).write_csv(__import__("os").path.join(__import__("os").path.dirname(__file__), "p07_trades_nom1.csv"))
